  ...
  return (
    <div className="mt-8 w-full max-w-full bg-black text-[#E6E6E6] font-bai p-3 rounded-[30px] flex items-center justify-center relative overflow-hidden group">
      ...
      <div className="absolute w-full h-full z-2 flex items-center justify-center">
        <button className="w-[130px] h-[130px] rounded-full flex items-center justify-center bg-[#a07af9] translate-y-100 transition-all duration-600 rotate-45 opacity-50 group-hover:translate-y-0 group-hover:rotate-0 group-hover:opacity-100">
