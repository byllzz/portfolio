...
export default function AboutSection() {
  return (
    <div className="space w-full max-w-full flex flex-col items-start gap-2 bg-black text-white rounded-[30px] pr-10 pl-6 pt-5 pb-7">
      ...
      <Link to="/about" className="group mt-3 w-full p-[11px] flex items-center justify-center font-bai gap-2 font-medium text-[#a07af9] text-[14px] cursor-pointer bg-[#111] rounded-xl">
        More about Me{' '}
