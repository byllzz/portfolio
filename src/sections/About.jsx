  ...
  return (
    <section className={styles.aboutSection}>
      <div className={styles.aboutSectionData}>
        <span className={styles.tag}>01 / PROFESSIONAL PROFILE</span>
        ...
        <button className={styles.resumeBtn}>
          <span><svg width="24px" height="24px" viewBox="0 0 24 24" fill="" xmlns="http://www.w3.org/2000/svg">
              <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
              <g id="SVGRepo_tracerCarrier" strokLinecap="round" strokeLinejoin="round"></g>
