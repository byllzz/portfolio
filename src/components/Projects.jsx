          ...
          return (
            <div id={item.id} className="flex flex-col items-start gap-2">
              ...
              <div className='flex items-center gap-2 relative left-1'>
                <span className=' text-[23px]'><HiLink /></span>
              <h3 className='text-[22px] font-medium font-bai'>{item.title}</h3>
              </div>
              <div className='flex items-center gap-2 w-full'>
                <a href={item.links?.repo} className='bg-[#111] py-3 px-4 w-[40%] flex items-center justify-center rounded-[12px] font-bai gap-1'>Code <span>
                  <BsCodeSlash />
                  </span> </a>
                <a href={item.links?.demo} className='w-full py-3 px-4
                 bg-[#a07af9] flex items-center justify-center font-bai gap-1 rounded-[12px] text-black font-medium'>Demo <span>
                  <GoArrowUpRight />
                  </span> </a>
              </div>
            </div>
